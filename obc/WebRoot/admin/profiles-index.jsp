					...
					<div class="panel-group" id="accordion">
						<div class="panel panel-default">
							...
							<s:url action="new" includeContext="true" var="newurl"/>
								<div class="btn-toolbar" role="toolbar" aria-label="profile toolbar">
									<button formaction="${showurl}" data-toggle="modal" data-target="#myModal" class="btn  btn-primary"
										id='btn-show-profile' disabled>
										<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Open
									</button>
									<button formaction="${newurl}" class="btn  btn-primary" id="btn-new-profile">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="dataTable_wrapper">
									<table class="table responsive table-striped table-bordered table-hover" id="profiletable">
										<thead>
											<tr>
												<th>Name</th>
												<th>Email</th>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<button type="button" formaction="${editurl}" class="btn btn-primary" id="btn-edit-profile">Edit</button>
											</div>
										</div>
									</div>
									<!-- /.modal-dialog -->
		...
		$(document).ready(function() {
			...
			table.on('select', function() {
				if (table.rows({
					...
					$('#btn-show-profile').attr("disabled", true);
				} else {
					$('#btn-show-profile').removeAttr("disabled");
				}
